...
export default async function CeklisLatihanOrangTuaPage({ searchParams }: { searchParams: Promise<{ kelas?: string }> }) {
  ...
  return (
    <div className="stack">
      <PageHero
        eyebrow="Monitoring • Ceklis Latihan"
        title="Ceklis penyelesaian latihan anak"
        description="Pilih kelas anak untuk melihat latihan Topik 1 sampai Topik 30. Centang hijau menandakan seluruh soal latihan pada topik tersebut sudah dijawab."
      />
        ...
        <section className="card stack">
          <div className="section-title-row">
            <div>
              ...
              <strong>{selectedStudents.length} anak terhubung</strong>
            </div>
            ...
            <table className="data-table class-report-table practice-checklist-table">
              ...
              <tbody>
                {selectedStudents.length ? selectedStudents.map((student, index) => (
                  ...
                  <tr><td colSpan={TOPIC_COLUMN_COUNT + 2}><div className="empty-state">Tidak ada anak terhubung pada kelas ini.</div></td></tr>
                )}
              </tbody>
            </table>
          </div>
